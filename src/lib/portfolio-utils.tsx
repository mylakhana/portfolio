...
export const getProficiencyPercentage = (level: string): number => {
...
export const getProficiencyColor = (level: string): { bg: string; text: string; border: string; barBg: string } => {
  switch (level.toLowerCase()) {
    case "expert":
      return {
    ...
    case "moderate":
      return {
        bg: "bg-amber-50/30 dark:bg-gray-800/10",
        text: "text-amber-500 dark:text-gray-500",
        border: "border-amber-200/30 dark:border-gray-700/20",
        barBg: "bg-amber-400/70 dark:bg-gray-500/50"
      };
    case "low":
      return {
        bg: "bg-gray-50/30 dark:bg-amber-950/10",
        text: "text-gray-500 dark:text-amber-500",
        border: "border-gray-200/30 dark:border-amber-800/20",
        barBg: "bg-gray-400/70 dark:bg-amber-500/50"
      };
    default:
      return {
